    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'operator', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:operator')))
                ...
                set_model_data(model, 'length', entry.at_xpath('./fhir:length/@value').try(:value))
