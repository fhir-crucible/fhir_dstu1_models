    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'practitioner', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:practitioner')))
                set_model_data(model, 'encounter', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:encounter')))
                set_model_data(model, 'prescription', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:prescription')))
                ...
                set_model_data(model, 'device', entry.xpath('./fhir:device').map {|e| FHIR::ResourceReference.parse_xml_entry(e)})
