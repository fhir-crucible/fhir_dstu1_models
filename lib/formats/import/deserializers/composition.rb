    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry_CompositionAttesterComponent(entry) 
                ...
                set_model_data(model, 'party', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:party')))
                model
            end
            ...
            def parse_xml_entry_SectionComponent(entry) 
                ...
                set_model_data(model, 'content', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:content')))
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'custodian', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:custodian')))
                set_model_data(model, 'event', parse_xml_entry_CompositionEventComponent(entry.at_xpath('./fhir:event')))
