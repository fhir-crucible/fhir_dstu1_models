module FHIR
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry_ScheduleRepeatComponent(entry) 
                return nil unless entry
                model = FHIR::Schedule::ScheduleRepeatComponent.new
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'repeat', parse_xml_entry_ScheduleRepeatComponent(entry.at_xpath('./fhir:repeat')))
                model
            end
        end
    end
