    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry_ProcedurePerformerComponent(entry) 
                ...
                set_model_data(model, 'person', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:person')))
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'report', entry.xpath('./fhir:report').map {|e| FHIR::ResourceReference.parse_xml_entry(e)})
