    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            ...
            def parse_xml_entry_ImmunizationVaccinationProtocolComponent(entry) 
                ...
                set_model_data(model, 'authority', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:authority')))
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'requester', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:requester')))
                set_model_data(model, 'manufacturer', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:manufacturer')))
