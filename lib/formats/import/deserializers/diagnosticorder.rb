    ...
    module Deserializer
        ...
        include FHIR::Deserializer::Utilities
            def parse_xml_entry_DiagnosticOrderEventComponent(entry) 
                ...
                set_model_data(model, 'actor', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:actor')))
                model
            end
            ...
            def parse_xml_entry(entry) 
                ...
                set_model_data(model, 'orderer', FHIR::ResourceReference.parse_xml_entry(entry.at_xpath('./fhir:orderer')))
